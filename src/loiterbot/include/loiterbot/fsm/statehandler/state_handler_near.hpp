...
#ifndef LOITERBOT__FSM__STATEHANDLER__STATE_HANDLER_NEAR_HPP_
#define LOITERBOT__FSM__STATEHANDLER__STATE_HANDLER_NEAR_HPP_
...
#endif  // LOITERBOT__FSM__STATEHANDLER__STATE_HANDLER_NEAR_HPP_
